	    ...
	    <div class="row">
		  ...
		  <table class="table table-bordered table-sm">
		    <%
				...
				ArrayList<Menu> list = menuDAO.getInfo(date1, date2);
	    	...
	    	<tbody>
		    	<tr>
		    		<td><%if(list.get(i).getCode() == 1){out.println(list.get(i).getInfo());} %></td>
		    		<td><%if(list.get(i).getCode() == 1){out.println(list.get(i).getKcal());} %></td>
		    	</tr>
		    	<tr>
		    		<td><%if(list.get(i).getCode() == 2){out.println(list.get(i).getInfo());} %></td>
		    		<td><%if(list.get(i).getCode() == 2){out.println(list.get(i).getKcal());} %></td>
		    	</tr>
		    	<tr>
		    		<td><%if(list.get(i).getCode() == 3){out.println(list.get(i).getInfo());} %></td>
		    		<td><%if(list.get(i).getCode() == 3){out.println(list.get(i).getKcal());} %></td>
		    	</tr>
		   	 <%} %>
		    </tbody>
		  </table>
